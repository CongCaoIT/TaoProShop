            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-row">
                        ...
                        <input type="text" name="translate_meta_title" value="{{ old('meta_title', $model->meta_title ?? '') }}"
            ...
            <div class="row mt8">
                <div class="col-lg-12">
                    <div class="form-row">
                        ...
                        <input type="text" name="translate_meta_keyword" value="{{ old('meta_keyword', $model->meta_keyword ?? '') }}"
                            class="form-control" placeholder="" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="row mt8">
                <div class="col-lg-12">
                    <div class="form-row">
                        ...
                        <textarea type="text" name="translate_meta_description" id="meta_description" class="form-control" placeholder="" autocomplete="off">{{ old('meta_description', $model->meta_description ?? '') }}</textarea>
                    </div>
                </div>
            </div>
            <div class="row mt8">
                <div class="col-lg-12">
                    <div class="form-row">
                        ...
                        <div class="input-wrapper">
                            <input type="text" name="translate_canonical" value="{{ old('canonical', $model->canonical ?? '') }}"
