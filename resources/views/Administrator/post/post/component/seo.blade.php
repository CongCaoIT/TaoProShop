            ...
            <div class="seo-container">
                <div class="seo-container">
                    <div class="seo-container">
                        ...
                        <div class="canonical">
                            {{ old('canonical', $post->canonical ?? '') ? old('canonical', $post->canonical ?? '') : 'https://duong-dan-cua-ban.html' }}
                        </div>
            ...
            <div class="row mt8">
                <div class="col-lg-12">
                    <div class="form-row">
                        ...
                        <textarea type="text" name="meta_description" id="meta_description" class="form-control" placeholder="" autocomplete="off">{{ old('meta_description', $post->meta_description ?? '') }}</textarea>
                    </div>
                </div>
            </div>
            <div class="row mt8">
                <div class="col-lg-12">
                    <div class="form-row">
                        ...
                        <div class="input-wrapper">
                            <input type="text" name="canonical" value="{{ old('canonical', $post->canonical ?? '') }}" class="form-control"
                                placeholder="" autocomplete="off">
